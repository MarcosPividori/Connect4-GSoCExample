...
data Identifier = Dev Device | Web (TChan MsgFromPlayer) deriving Eq
type WebUsers   = HM.HashMap Text (TChan MsgFromPlayer,POSIXTime)
data MsgFromPlayer = Cancel | Movement Int | NewGame Text | Winner Text | NewMessage Text Text deriving (Show,Read,Eq)
